...
/* Set up our static filed web server to deliver files from the filesystem */
...
io.on('connection', (socket) => {
    ...
    */
    ...
    /* send_chat_mesasage command handler */
    /* expected payload:
        {
...
function adjacent_support(who, dr, dc, r, c, board) {
    ...
    /* Check to make sure that thaere is space for a matching color to capture tokens */
